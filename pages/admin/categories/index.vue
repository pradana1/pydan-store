                  ...
                  <div class="form-group">
                      <div class="input-group mb-3">
                          <div class="input-group-prepend">
                              <nuxt-link :to="{name: 'admin-categories-create'}" class="btn btn-sm" style="padding-top: 10px;">
                          ...
                          <div class="input-group-append">
                              <button  @click="searchData" class="btn"><i class="fa fa-search"></i>SEARCH</button>
                          </div>
                      </div>
                  </div>
