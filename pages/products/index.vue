<template>
  ...
  export default {
      ...
      head() {
        return {
          title: 'Products - PYDAN STORE - Distributor Xiaomi Indonesia Resmi',
          meta: [{
              hid: 'og:title',
              name: 'og:title',
              content: 'PYDAN STORE - Distributor Xiaomi Indonesia Resmi'
            },
            {
              hid: 'og:site_name',
              name: 'og:site_name',
              content: 'Products - PYDAN STORE - Distributor Xiaomi Indonesia Resmi'
            },
            {
              hid: 'og:image',
              name: 'og:image',
