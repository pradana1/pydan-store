    ...
    <div class="container-fluid mt-4 mb-5">
      ...
      <div class="row justify-content-center mt-4">
          <div class="text-center">
            <nuxt-link :to="{name: 'products'}" class="btn btn-lg border-0 rounded shadow-sm">LIHAT LEBIH BANYAK</nuxt-link>
          </div>
        </div>
    ...
    head() {
      return {
        ...
        meta: [{
            hid: 'og:title',
            name: 'og:title',
            content: 'GALERY PYDAN - Selamat Datang'
          },
          {
            hid: 'og:site_name',
            name: 'og:site_name',
          ...
          },
          {
            hid: 'og:image',
            name: 'og:image',
            content: '/images/pydan1.png'
          },
          {
            hid: 'description',
            name: 'description',
            content: 'Official Toko Online Penjualan Galery Pydannn'
          },
        ]
      }
    },
