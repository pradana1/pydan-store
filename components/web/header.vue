        ...
        <div class="row align-items-center">
          <div class="col-lg-3 col-sm-4 col-md-4 col-5"> 
              <nuxt-link to="/" class="brand-wrap" data-abc="true">
                <img src="/images/pydan1.png" width="35" class="bg-light p-2 rounded">
                <span class="logo">GALERY PYDAN</span>
              </nuxt-link>
          </div>
      ...
      <div class="container-fluid">
        <div class="d-md-none my-2">
          <div class="input-group"> 
            ...
            <div class="input-group-append"> 
              <button @click="searchData" class="btn"> <i class="fa fa-search"></i></button> 
            </div>
          </div>
        </div> 
